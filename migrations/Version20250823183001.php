 ...
 */
final class Version20250823183001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alumno (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, apellido VARCHAR(255) NOT NULL, correo VARCHAR(255) DEFAULT NULL, dni INTEGER NOT NULL, cuil INTEGER DEFAULT NULL)');
        ...
        $this->addSql('CREATE TABLE curso (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, carrera_id INTEGER DEFAULT NULL, nombre VARCHAR(255) NOT NULL, horas INTEGER NOT NULL, CONSTRAINT FK_CA3B40ECC671B40F FOREIGN KEY (carrera_id) REFERENCES carrera (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
